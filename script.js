...
const convidados = [
    ...
    { codigo: 'ana', nome: 'Aninha', foto: 'fotos/aninha.jpg', msgSim: 'vou largar minha viagem maravilhosa com meu namorado (que tu não conhece ainda) e vou ir', msgNao: 'não alipio, não vou deixar de ir numa viagem com meu namorado que conheci a pouco tempo atras para ir no aniversário do meu amigo de ANOS' },
    ...
    { codigo: 'carla', nome: 'Carlota', foto: 'fotos/carlota.jpg', msgSim: 'óbvio que vou né meu, como não vou no aniversario do MAGNÍFICO ALIPIO, meu maior amigo de todo que eu amo muitooo', msgNao: 'sou uma baita corna e não vou pq sou corna (muito corna)' },
    ...
    { codigo: 'matheus', nome: 'Matheus', foto: 'fotos/matheus.jpg', msgSim: 'óbvio que vou né meu, como não vou no aniversario do MAGNÍFICO primo alipio MEU DEUS DO CÉU OLHA A VANNN CUIDADOOOO', msgNao: 'sou um baita corno e não vou pq sou corno OLHA A VAN CUIDADOOOO MEU DEUSSS' },
